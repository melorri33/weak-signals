...
Все строки ниже второй считаются **одним** правилом — тем же, что в проверке «как у жюри»
(см. раздел 5б). Раньше разные шаги считались по-разному, и числа не сходились между собой.

**Главная потеря — между второй и третьей строкой: из 12 названных до кандидатов доходят 4.**
Причина не в качестве выделения, а в том, что модель не видит нужный документ: она читает
6–25% собранного (раздел 5). Разбор 12 названных технологий показал, почему это так тяжело
лечится: 9 из 12 встречаются ровно в одном документе корпуса, а 10 из 12 — ни разу
в заголовке. То есть документ написан не про них, технология упомянута одной фразой.

Дальше потери небольшие: все 4 кандидата доходят до скоринга, 3 из 4 попадают в топ-15.
Четвёртый получил оценку 0.05 и остался на 24-м месте.
